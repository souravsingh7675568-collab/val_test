      ...
      <div className="px-4 py-8 md:px-12 lg:px-24 max-w-7xl mx-auto text-gray-800 pt-20">
        ...
        <div className="space-y-6 text-sm md:text-base lg:text-lg leading-relaxed">
          <p>
            ...
            application and any of the platforms/tools developed by us from time
            to time (together referred to as Platform). These Terms along with
            the Privacy Policy published on our website ("Privacy Policy") and
            other policies (as may be notified/displayed/published on our
          ...
          <p>
            ...
            it is signified that the User agrees to abide by all our Terms
            and/or policies (as updated from time to time).
          </p>
          ...
          <ul className="list-disc list-inside space-y-2 pl-4">
            ...
            <li>
              ...
              Taxes applicable as per current statute in the country) regarding
          ...
          <h2 className="text-xl md:text-2xl font-semibold mt-8">Frauds</h2>
          <p>
          ...
          <h2 className="text-xl md:text-2xl font-semibold mt-8">Indemnity</h2>
          <p>
